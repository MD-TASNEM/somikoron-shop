...
export const AdminSettings = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-12">
        <h1 className="text-4xl font-extrabold text-secondary">System Settings</h1>
        <p className="text-secondary/60 text-lg">Configure your store's global parameters and security.</p>
      </div>
        ...
        <div className="lg:col-span-3 space-y-8">
          {activeTab === 'general' && (
            <section className="bg-white p-10 rounded-premium shadow-sm border border-secondary/5 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-secondary/60">Store Name</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-secondary/60">Support Email</label>
                  <input 
                    type="email" 
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-secondary/60">Currency</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-secondary/60">Store Address</label>
                <textarea 
              ...
              <div className="space-y-6">
                <div className="p-6 bg-secondary/5 rounded-2xl space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-3 py-1 bg-success/10 text-success rounded-full text-[10px] font-bold uppercase tracking-widest">Connected</span>
                  </div>
          ...
          {activeTab === 'shipping' && (
            <section className="bg-white p-10 rounded-premium shadow-sm border border-secondary/5 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-secondary/60">Inside Dhaka Fee (৳)</label>
                  <input 
                    type="number" 
                    defaultValue="70"
                    className="w-full px-6 py-4 bg-secondary/5 border-none rounded-xl focus:ring-2 focus:ring-primary/20 outline-none transition-all"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-secondary/60">Outside Dhaka Fee (৳)</label>
                  <input 
                    type="number" 
                    defaultValue="130"
                    className="w-full px-6 py-4 bg-secondary/5 border-none rounded-xl focus:ring-2 focus:ring-primary/20 outline-none transition-all"
