...
export const PaymentCancel = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      ...
      >
        <div className="inline-flex items-center justify-center w-24 h-24 bg-warning/10 rounded-full text-warning mb-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-secondary/60">
            You cancelled the payment process. Your order has been saved and you
            can try again later.
          </p>
        </div>
        ...
        {orderId && (
          <div className="p-6 bg-secondary/5 rounded-2xl border border-secondary/5 space-y-4">
            ...
            <div className="text-xs text-secondary/60">
              Your order has been saved. You can complete the payment later from
              your orders page.
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 gap-4">
          {orderId ? (
            <Link
              ...
              className="w-full bg-warning text-white py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-warning/90 transition-all shadow-lg group"
            >
