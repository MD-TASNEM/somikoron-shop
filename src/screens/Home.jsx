  ...
  return (
    <div className="space-y-20 pb-20">
      ...
      >
        ...
        >
          <h1 className="tracking-tight flex flex-col gap-2">
            <span className="text-primary text-4xl md:text-6xl lg:text-8xl font-extrabold block">
              সমীকরণ শপে
            </span>
            <span className="text-white text-3xl md:text-5xl lg:text-7xl font-extrabold block">
              স্বাগতম।
            </span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center pt-4">
            <Link
              to="/category/all"
              className="bg-primary hover:bg-primary/90 active:scale-95 px-8 py-4 rounded-full text-white font-bold flex items-center gap-2 transition-all shadow-lg hover:shadow-primary/20"
            >
            ...
            <a
              ...
              className="bg-[#25D366] hover:bg-[#128c7e] active:scale-95 px-8 py-4 rounded-full text-white font-bold flex items-center gap-2 transition-all shadow-lg hover:shadow-green-500/20"
            >
              ...
              <div className="relative w-full h-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-12 text-white">
                  ...
                  >
                    ...
                    <Link
                      to={slide.link}
                      className="inline-flex items-center gap-2 bg-primary px-6 py-3 rounded-full font-bold hover:bg-primary/90 transition-colors"
                    >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="offers">
        <div className="bg-gradient-to-br from-primary to-primary/90 rounded-premium p-10 sm:p-16 text-center text-white shadow-2xl space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="animate-pulse space-y-4">
                <div className="bg-gray-200 h-64 rounded-premium"></div>
          ...
          {[
            {
              Icon: Truck,
              title: "Free Shipping",
              desc: "Free delivery on all orders over ৳500",
            },
            {
              Icon: ShieldCheck,
            ...
            <div
              key={index}
              className="bg-white p-8 rounded-premium shadow-sm text-center space-y-4 hover:shadow-md transition-all group"
            >
